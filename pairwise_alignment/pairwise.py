...
# 7 November 2012
#
# Generates a pairwise sequence alignment given a matrix scoring file
# and a sequence pair file in FASTA format using the Needleman-Wunsch
# algorithm with a linear gap penalty
#
# input from command line has the format:
...
def main():
	...
	string1name = seqList[SEQ1LOC][NAMELOC][1:].strip().upper()
	string1 	= seqList[SEQ1LOC][SEQLOC]
	string2name	= seqList[SEQ2LOC][NAMELOC][1:].strip().upper()
